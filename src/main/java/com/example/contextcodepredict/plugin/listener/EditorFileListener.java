...
//    });
  ...
  public void addNewTaskContext(@NotNull PsiFile file) {
    PsiClass[] psiClasses = new PsiClass[1];
    PsiTreeUtil.findChildrenOfType(file.getNavigationElement(), PsiClass.class).toArray(psiClasses);
