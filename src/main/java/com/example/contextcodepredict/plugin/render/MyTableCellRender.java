...
public class MyTableCellRender extends DefaultTableCellRenderer {
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
    ...
    if (value instanceof PsiClass) {
      ...
      setToolTipText(psiObject.getQualifiedName());
      ...
      if (psiObject.getReturnType() == null) {
        ...
        setToolTipText(psiObject.getName() + psiObject.getParameterList().getText());
      } else {
        setText(psiObject.getName() + psiObject.getParameterList().getText() + ": " + psiObject.getReturnType().getCanonicalText());
        setToolTipText(psiObject.getName() + psiObject.getParameterList().getText() + ": " + psiObject.getReturnType().getCanonicalText());
      }
      ...
      setToolTipText(psiObject.getName() + ": " + psiObject.getType().getPresentableText());
      setIcon(fieldIcon);
    } else {
      setIcon(otherIcon);
